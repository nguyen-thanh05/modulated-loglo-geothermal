#!/usr/bin/env python3
"""Submit the Modulated LOGLO-FNO loss-ablation study."""
...
JOBS_PER_CHAIN = 4
CONFIGS = (
    "configs/loss_ablation/modulated_loglo_no_h1.yml",
    "configs/loss_ablation/modulated_loglo_no_mbe.yml",
    "configs/loss_ablation/modulated_loglo_no_spectral.yml",
    "configs/loss_ablation/modulated_loglo_no_pushforward.yml",
)
